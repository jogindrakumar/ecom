...
<div class="row"> <!-- start 7th row  -->
	    ...
	    <div class="form-group">
			...
			<div class="controls">
	<textarea name="short_descp_en" id="textarea" class="form-control" value="" required placeholder="Textarea text">
    {{$products->short_descp_en}}    
	     ...
	     <div class="form-group">
			...
			<div class="controls">
	<textarea name="short_descp_hin" id="textarea" class="form-control" value="" required placeholder="Textarea text">
...
<div class="row"> <!-- start 8th row  -->
	    ...
	    <div class="form-group">
			...
			<div class="controls">
	<textarea id="editor1" name="long_descp_en" value="" rows="10" cols="80" required="">
		{{$products->long_descp_en}}
	     ...
	     <div class="form-group">
			...
			<div class="controls">
	<textarea id="editor2" name="long_descp_hin" value="" rows="10" cols="80">
